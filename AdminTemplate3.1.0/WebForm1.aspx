                ...
                <div class="area">
                    ...
                    <div class="radioinput">
                        <div class="radio">
                            ...
                            <div>
                                <input type="radio" id="yes" name="hazard_study" value="Yes" onclick="toggleFileInput(true)">
                                <label for="yes">Yes</label>
                                <input type="radio" id="no" name="hazard_study" value="No" onclick="toggleFileInput(false)">
                            ...
                            <div class="control-group">
                                <div class="alert alert-error" id="noty" style="width: 36%">
                                    <label class="control-label1" style="margin-top: 5px; font-size: 16px">File Upload (optional)</label>
                                    <div class="controls" style="margin-top: -35px;">
                                        <asp:FileUpload ID="FileUpload1" CssClass="CS" runat="server" Font-Size="12px" />
                                        <span>Maximum allowed file size is 5 MB</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <style>
                     ...
                     <div class="form-actions1 span12" style="margin-left: -10px">
